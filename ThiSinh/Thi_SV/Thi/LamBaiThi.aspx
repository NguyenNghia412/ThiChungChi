<%@ Page Title="Làm bài thi" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LamBaiThi.aspx.cs" Inherits="Thi_SV.LamBaiThi" %>
    ...
    <div id="wrapper">
        ...
        <script>
            var Thi = {
                ...
                NopBai: function () {
                    var r = confirm("Bạn có chắc chắn muốn nộp bài");
                    if (r == true) {
                        doPostBackAnswares();
                ...
                UpdateStatus: function (callback) {
                    const url = '/Handler/nuce.thichungchi/tcc_updatestatus.ashx';
                    const body = JSON.stringify({ id: iIDKiThiLopHocSinhVien, status: 3 });
            ...
            function doPostBackAnswares() {
                if (checkOnbeforeunload == 0) {
                    checkOnbeforeunload = 1;
                    collectAnswares();
                    $.post("/Handler/nuce.thichungchi/NopBai/",
            ...
            function doPostBackAnswares1() {
                if (checkOnbeforeunload == 0) {
                    collectAnswares();
                    $.post("/Handler/nuce.thichungchi/NopBai/", { kithilophocsinhvien: iIDKiThiLopHocSinhVien, bailam: m_strAnwares, action: "nopbai" });
                }
            };
            function doPostBackAnswares2() {
                if (checkOnbeforeunload == 0) {
                    collectAnswares();
                    $.post("/Handler/nuce.thichungchi/NopBai/", {
                        kithilophocsinhvien: iIDKiThiLopHocSinhVien, bailam: m_strAnwares, action: "dangthi"
                    }, function(data) {
                            ExamHubController.sendMsg('1');
                        });
                }
