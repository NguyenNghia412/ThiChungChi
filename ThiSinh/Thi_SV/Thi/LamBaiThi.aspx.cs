...
namespace Thi_SV
{
    public partial class LamBaiThi : System.Web.UI.Page
    {
        ...
        string getItemHtmlNormal(model.CauHoi cauhoi, List<model.DapAn> dapAn, int l, int l1, string index, string color, out string strScript, out string strNoiDungDapAn, out string strCheckboxDapAn)
        {
