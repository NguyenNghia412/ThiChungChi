...
namespace nuce.web.data
{
    public static class DataUtils
    {
        ...
        public static Dictionary<int, Nuce.CTSV.Model.LoaiDichVu> getLoaiDichVuSinhVien()
        {
            ...
            temp.Add(6, new Nuce.CTSV.Model.LoaiDichVu(6, "", "Dịch vụ vay vốn ngân hàng", "", "AS_Academy_Student_SV_VayVonNganHang", "/tabid/46/default.aspx", ""));
            temp.Add(7, new Nuce.CTSV.Model.LoaiDichVu(6, "", "Dịch vụ thuê nhà ở sinh viên", "", "AS_Academy_Student_SV_ThueNha", "/tabid/47/default.aspx", ""));
            return temp;
        }
