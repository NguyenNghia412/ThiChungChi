<%@ Page Title="Đăng nhập" Language="C#" MasterPageFile="~/Site.Login.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Nuce.CTSV.Login" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <%--  <div class="form-group">
    ...
    <asp:Button CssClass="btn btn-primary btn-user btn-block" runat="server" ID="btnDangNhap" Text="Đăng nhập" OnClick="btnDangNhap_Click" />
    <hr />
    <a
