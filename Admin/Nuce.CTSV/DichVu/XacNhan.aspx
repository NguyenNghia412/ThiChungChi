<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="XacNhan.aspx.cs" Inherits="Nuce.CTSV.XacNhan" %>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="btnXacNhanXa" onclick=" XacNhan.update();">Xác nhận mã</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnXoa" onclick=" XacNhan.delete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnHoanThanh" onclick=" XacNhan.complete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row row-no-gutters">
            ...
            <div class="col-sm-4" style="text-align:right;">
                <button type="button" class="btn btn-primary" onclick="XacNhan.ThemMoi();">Thêm mới</button>
            </div>
        </div>
        ...
        var XacNhan = {
            ...
            update: function () {
                ...
                if (XacNhan.ID > 0) {
                    try {
                        //Update
                        $.getJSON(this.url + "CapNhatMaYeuCauDichVu.aspx?ID=" + XacNhan.ID + "&&Ma=" + strMa + "&&Type=1", function (data) {
                            $("#edit_header_ThongBao").show();
                            if (data == 1) {
            ...
            initDelete: function (id, message) {
                ...
                $('#btnXoa').show();
                //$("#btnXoa").on("click", XacNhan.delete);
            },
            delete: function () {
                //Update
                $("#edit_header_ThongBao1").show();
                try {
                    $.getJSON(this.url + "HuyDichVu.aspx?ID=" + XacNhan.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            complete: function () {
                ...
                try {
                    $.getJSON(this.url + "HoanThanhDichVu.aspx?ID=" + XacNhan.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/xacnhan_yeucaumoi";
            }
        };
    </script>
</asp:Content>
