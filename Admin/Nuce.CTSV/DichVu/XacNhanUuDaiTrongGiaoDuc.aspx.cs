...
namespace Nuce.CTSV
{
    public partial class XacNhanUuDaiTrongGiaoDuc : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string sql = "select top 100 * from AS_Academy_Student_SV_XacNhanUuDaiTrongGiaoDuc where Deleted<>1 and StudentID=" + m_SinhVien.SinhVienID + " order by LastModifiedTime desc";
