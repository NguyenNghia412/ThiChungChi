    ...
    public partial class XacNhan_YeuCauMoi : BasePage
    {
        ...
        protected void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = string.Format(@"INSERT INTO [dbo].[AS_Academy_Student_SV_XacNhan]
     ...
     VALUES
           ...
           ,@Param3,@Param4,@Param5)");
                ...
                if (iReturn > 0)
                {
                    divThongBao.InnerHtml = "Xem Kết quả xử lý tại email cá nhân hoặc đăng nhập vào tài khoản tại http://sv.nuce.edu.vn";
                    divThongBaoCapNhat.InnerHtml = "Xem Kết quả xử lý tại email cá nhân hoặc đăng nhập vào tài khoản tại http://sv.nuce.edu.vn";
                    #region Gui email
                    string strEmail = m_SinhVien.Email;
                    int iIDSV = m_SinhVien.SinhVienID;
                    string strCode = m_SinhVien.MaSV;
                    // gui email
                    string strTieuDe = string.Format("Xác nhận yêu cầu dịch vụ xin giấy xác nhận sinh viên");
