...
namespace nuce.web.commons
{
    ...
    public class ad_tcc_updatethisinhtrongkithi : CoreHandlerCommonAdminThiChungChi
    {
        public override void WriteData(HttpContext context)
        {
            ...
            string strIdPhongCaNgay = context.Request["IDPhongCaNgay"].ToString();
            ...
            foreach (string strTemp in strSplits)
            {
                ...
                BEGIN
                    ...
                    set Type=1, PhongThi_CaThi_ID = {2}
                    where KiThi_LopHocID={0} and SinhVienID={1};
                END;", strID, strTemp, strIdPhongCaNgay);
                }
                else
                {
