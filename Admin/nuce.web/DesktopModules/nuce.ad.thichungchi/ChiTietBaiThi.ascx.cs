...
{
    public partial class ChiTietBaiThi : PortalModuleBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
               ...
               DataTable dtKiThiLopHocSinhVien = web.data.dnn_NuceThi_KiThi_LopHoc_SinhVien.get(iKiThiLopHocSinhVienID);
                ...
                web.model.KiThiLopHocSinhVien KiThiLopHocSinhVien = new web.model.KiThiLopHocSinhVien();
                ...
                strMoTa += string.Format("<tr><td style='color:red;font-weight: bold;'>Mã SV: </td><td>{0}</td>", dtKiThiLopHocSinhVien.Rows[0]["Ma"].ToString());
                strMoTa += string.Format("<td style='color:red;font-weight: bold;'>Tên sinh viên: </td><td>{0} {1}</td></tr>", dtKiThiLopHocSinhVien.Rows[0]["Ho"].ToString(), dtKiThiLopHocSinhVien.Rows[0]["Ten"].ToString());
        ...
        string getDivRowHtmlNormal(web.model.CauHoi cauhoi, List<web.model.DapAn> dapAn, web.model.DapAn answare, int l, int l1, string index, string color, out string strScript)
        {
