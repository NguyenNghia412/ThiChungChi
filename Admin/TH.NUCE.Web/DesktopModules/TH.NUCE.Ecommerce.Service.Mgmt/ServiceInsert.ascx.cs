...
{
    public partial class ServiceInsert : CoreModule, IActionable
    {
        #region private item
        private string m_strCategories;
        private string m_strFolderName;
        private int m_Serviced;
        ...
        {
            DataTable objTableData = ServiceProvider.GetService(m_Serviced);
            if (objTableData.Rows.Count > 0)
            {
               lblError.Text = "Cập nhật dịch vụ";
               ...
               txtAddRichInfo1.Text = objTableData.Rows[0]["AddRichInfo1"] == null ? "" : objTableData.Rows[0]["AddRichInfo1"].ToString();
               txtAddRichInfo2.Text = objTableData.Rows[0]["AddRichInfo2"] == null ? "" : objTableData.Rows[0]["AddRichInfo2"].ToString();
               txtAddRichInfo3.Text = objTableData.Rows[0]["AddRichInfo3"] == null ? "" : objTableData.Rows[0]["AddRichInfo3"].ToString();
