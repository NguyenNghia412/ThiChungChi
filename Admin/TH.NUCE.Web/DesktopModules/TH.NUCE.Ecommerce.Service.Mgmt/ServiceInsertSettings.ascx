<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServiceInsertSettings.ascx.cs"
    Inherits="TH.NUCE.Web.ServiceInsertSettings" %>
...
<table cellspacing="1" cellpadding="1" width="100%" border="0">
    ...
    <tr>
        ...
        <tr>
        <td width="30%" align="left" class="SubHead">
            <dnn:Label ID="lblLinkUpload" runat="server" ControlName="txtLinkUpload" Suffix=":"></dnn:Label>
        </td>
        <td width="70%">
            <asp:TextBox ID="txtLinkUpload" runat="server" MaxLength="500" Width="100%"></asp:TextBox>
        </td>
    </tr>
</table>
