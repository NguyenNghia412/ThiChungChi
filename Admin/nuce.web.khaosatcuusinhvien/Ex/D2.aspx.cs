...
namespace nuce.web.thanhnt
{
    public partial class D2 : System.Web.UI.Page
    {
        ...
        protected void btnNopBai_Click(object sender, EventArgs e)
        {
            ...
            string strDoiTuongTraLoi = "BSDLD";
            //nuce.web.data.Nuce_Survey.InsertAS_Edu_Survey_Ext_BaiLam(1, "ThanhNT_PHD", strHoTen, iGioiTinh, strEmail, "", strTenCoQuan, strDoiTuongTraLoi, 2, strAnswares);
