...
declare @DapAn  nvarchar(max)
select @NoiDung = NoiDungDeThi, @DapAn = DapAn from[NUCE_Khao_sat_cuu_sinh_vien_2016_2017].[dbo].[dnn_NuceThi_DeThi]
where BoDeID = 1019
update[dbo].[dnn_Nuce_KS_SinhVienRaTruong_BaiKhaoSat_SinhVien]
set DapAn = @DapAn, NoiDungDeThi = @NoiDung, BaiLam = ''
where SinhVienID = 2566*/
namespace nuce.web
{
    public partial class Khao_sat_cuu_sinh_vien : System.Web.UI.Page
    {
        ...
        protected void btnNopBai_Click(object sender, EventArgs e)
        {
            ...
            m_KiThiLopHocSinhVien.Status = 3;
            m_KiThiLopHocSinhVien.BaiLam = strAnswares;
            ...
            m_SinhVien.CMT = txtCMT.Text.Trim();
