    ...
    public partial class NotRead : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    DataSet ds = nuce.web.data.Nuce_DanhGiaGiangVien.getQA_QuestionNotReadByLecturer(m_CanBo.ID);
                    ...
                    if (dtSubject.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dtSubject.Rows.Count; i++)
                        {
                            ...
                            {
                                //Kiem tra co type va có câu trả lời không
                    ...
                    {
                        infoLe.InnerText = string.Format("{0}({1}): Bạn không có phản hồi chưa đọc.", m_CanBo.Ten, m_CanBo.MaCB);
                    }
                }
            }
        }
