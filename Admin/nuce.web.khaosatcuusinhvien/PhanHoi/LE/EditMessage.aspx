<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMessage.aspx.cs" Inherits="nuce.web.phanhoi.le.EditMessage" %>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div style="border: 1px solid #ccc; padding: 10px 10px; margin-bottom: 10px; min-height: 245px;">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox class="form-control" runat="server" ID="txtMessage" TextMode="MultiLine" Widtd="100%"></asp:TextBox>
                            </div>
                            <div class="form-group">
