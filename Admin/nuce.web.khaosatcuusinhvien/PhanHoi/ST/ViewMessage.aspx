<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMessage.aspx.cs" Inherits="nuce.web.phanhoi.st.ViewMessage" %>
                ...
                <div id="header">
                    ...
                    <div class="menuheader1" runat="server" id="mo_menuheader">
                        ...
                        <select>
                            ...
                            <option value="/phanhoi/st/AddFeedBack.aspx">Đặt câu hỏi</option>
                        </select>
                        <div class="clearfix">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="form_dk">
                            <div class="form-group">
                                ...
                                <div runat="server" id="divViewMessage"></div>
                                <asp:TextBox class="form-control" runat="server" ID="txtMessage" TextMode="MultiLine" Widtd="100%" Visible="false"></asp:TextBox>
                            </div>
                            <div class="form-group">
