<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SuaDapAn.aspx.cs" Inherits="nuce.web.admin.KhaoSat.SuaDapAn" %>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div style="display: none;">
                    ...
                    <asp:TextBox ID="txtCauHoiID" runat="server"></asp:TextBox>
                    <asp:TextBox ID="txtGCauHoiID" runat="server"></asp:TextBox>
                </div>
                <div id="footer">
