...
namespace nuce.web
{
    public partial class Khao_sat_sinh_vien_sap_ra_truong_luu_bai : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (m_KiThiLopHocSinhVien.Status!=4)
                    {
                        ...
                        data.dnn_Nuce_KS_SinhVienSapRaTruong_BaiKhaoSat_SinhVien1.update_bailam1(m_KiThiLopHocSinhVien.KiThi_LopHoc_SinhVien, strAnswares, DateTime.Now, Utils.GetIPAddress(), 1);
                    }
                    strData = "1";
                }
            }
