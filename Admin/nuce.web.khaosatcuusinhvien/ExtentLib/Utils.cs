...
namespace nuce.web
{
    public static class Utils
    {
        ...
        */
        ...
        #endregion
        #region khaosat
        public static string session_canbo = "session_canbo";
        ...
        public static string session_sinhvienchuanbitotnghiep = "session_sinhvienchuanbitotnghiep";
        public static string session_kithi_lophoc_sinhvienchuanbitotnghiep = "session_kithi_lop_hoc_sinhvienchuanbitotnghiep";

        public static string session_sinhvien_khaosatdanhgiagiangvien = "session_sinhvien_khaosatdanhgiagiangvien";
        public static string session_kithi_lop_hoc_sinhvien_khaosatdanhgiagiangvien = "session_kithi_lop_hoc_sinhvien_khaosatdanhgiagiangvien";

        public static string session_sinhvien_qa = "session_sinhvien_qa";
        public static string session_giangvien_qa = "session_giangvien_qa";

        public static string session_admin_user = "session_admin_user";
    ...
    "y","y","y","y","y",};
        ...
        public static model.KiThiLopHocSinhVien chamBai(model.KiThiLopHocSinhVien KiThiLopHocSinhVien, string Answares)
        {
            ...
            KiThiLopHocSinhVien.Mota = string.Format("<div style='width: 80%;text-align: center;font-weight: bold;font-size: 20px;color: red;padding-top: 20px;'>{0}</div>", KiThiLopHocSinhVien.Mota);
        ...
        public static string Send_Email(string Subject, string Message, string EmailTo)
        {
            try
            {
                ...
                string strPasswordSend = "ktdb@320a1";
                //khaosatktdb@123
    ...
    public static class UtilsDisplayDe
    {
        ...
        public static string getStringIndexLaMa(int l)
        {
            switch (l)
            {
                case 1: return "I";
