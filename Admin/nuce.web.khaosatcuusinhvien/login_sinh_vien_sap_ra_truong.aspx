<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_sinh_vien_sap_ra_truong.aspx.cs" Inherits="nuce.web.login_sinh_vien_sap_ra_truong" %>
        ...
        <div class="container">
            <div class="row ">
                <div id="header">
                    ...
                    <ul class="menuheader">
                        <li><a href="/KhaoSat/Default.aspx" class="home">Home</a> </li>
                        ...
                        <li><a href="http://www.nuce.edu.vn/vi/thong-bao/ktdb-thong-bao-vv-trien-khai-cong-tac-lay-y-kien-phan-hoi-cua-sinh-vien-truoc-khi-tot-nghiep-dot-thang-02-nam-2020-ve-chat-luong-dao-tao.html" target="_blank">Hướng dẫn</a> </li>
                    </ul>
                    <div class="clear">
                    </div>
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="form_dk">
                            ...
                            <div class="text col-xs-12 col-md-12" style="text-align: left; padding-top: 1px; padding-right: 1px;">
                                <b>Khảo sát phản hồi của sinh viên trước khi tốt nghiệp đợt tháng 02 năm 2020 về CTĐT.</b> </br></br>
