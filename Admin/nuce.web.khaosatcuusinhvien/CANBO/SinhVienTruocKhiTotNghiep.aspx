<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SinhVienTruocKhiTotNghiep.aspx.cs" Inherits="nuce.web.SinhVienTruocKhiTotNghiep" %>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="form_dk">
                            ...
                            <div class="input col-xs-12 col-md-8">
                                <asp:TextBox runat="server" ID="txtMSV"></asp:TextBox>
                                <asp:Button runat="server" ID="btnTim" Text="Tìm" OnClick="btnTim_Click" />
                            </div>
