...
namespace nuce.web
{
    public partial class Khao_sat_sinh_vien_m4 : System.Web.UI.Page
    {
        ...
        protected void btnNopBai_Click(object sender, EventArgs e)
        {
            ...
            m_KiThiLopHocSinhVien.LecturerCode = ddlGiangVien.SelectedValue;
            string strNameGiangVien = ddlGiangVien.SelectedItem.Text;
            int i = strNameGiangVien.IndexOf("(");
            if (i > 0)
                strNameGiangVien = strNameGiangVien.Remove(i);
            strNameGiangVien.Trim();
            m_KiThiLopHocSinhVien.LecturerName = strNameGiangVien;
            ...
            data.Nuce_Survey.Edu_Survey_BaiKhaoSat_SinhVien_update_giangvien(m_KiThiLopHocSinhVien.KiThi_LopHoc_SinhVien, m_KiThiLopHocSinhVien.LecturerCode, m_KiThiLopHocSinhVien.LecturerName);
