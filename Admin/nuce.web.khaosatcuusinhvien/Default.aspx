<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="nuce.web.khaosatcuusinhvien.Default" %>
            ...
            <div class="row ">
                ...
                <div class="body">
                    <%-- <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color: #0f297e;padding-top: 68px;">
                             <a style="color: yellow;text-align: center; cursor: pointer; font-weight: bold; font-size: large" href="/KSHDGD/login_sinh_vien">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color: #0f297e; padding-top: 68px;">
                            <a style="color: yellow; text-align: center; cursor: pointer; font-weight: bold; font-size: large" href="/Khao_sat_cuu_sinh_vien">
                                <p style="text-align: center; text-transform: uppercase;">
                                    Khảo sát tình hình việc làm của cựu sinh viên tốt nghiệp năm học 2018-2019
                                </p>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color: floralwhite; padding-top: 68px;">
                    ...
                    <%-- <div class="col-md-4 col-xs-12">
                        <div class="form_home" style="background-color:#ead7af;padding-top: 68px;">
                            <a style="color: #0f297e;cursor: pointer; font-weight: bold; font-size: large" href="/phanhoi/default.aspx">
                                <p style="text-align:center;">
                                  SINH VIÊN PHẢN HỒI TRONG QUÁ TRÌNH HỌC
                                </p>
                            </a>
                        </div>
                    </div>--%>
