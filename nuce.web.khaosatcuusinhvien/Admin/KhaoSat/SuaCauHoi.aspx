<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SuaCauHoi.aspx.cs" Inherits="nuce.web.admin.KhaoSat.SuaCauHoi" %>
            ...
            <div class="row ">
                ...
                <div class="body">
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="thutu">Loại câu hỏi:</label>
                            <asp:TextBox ID="txtLoaiCauHoi" runat="server" class="form-control" TextMode="SingleLine"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="thutu">Thứ tự:</label>
                            <asp:TextBox ID="txtThuTu" runat="server" class="form-control" TextMode="Number"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Button class="btn btn-primary" ID="btnCapNhat" runat="server" Text="Cập nhật" OnClick="btnCapNhat_Click" />

                            <asp:Button class="btn btn-primary" ID="btnQuayLaiDanhSach" runat="server" Text="Quay lại danh sách" OnClick="btnQuayLaiDanhSach_Click" />
                        </div>
                    </div>
