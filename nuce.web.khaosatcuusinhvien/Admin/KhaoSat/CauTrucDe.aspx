<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CauTrucDe.aspx.cs" Inherits="nuce.web.admin.KhaoSat.CauTrucDe" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="body">
                    <div class="col-md-12 col-xs-12" style="padding-bottom: 5px; text-align: center;" id="divThongBao" runat="server">
                    </div>
                    <div class="col-md-12 col-xs-12" style="padding-bottom: 5px; text-align: center;">
                        <div class="form-inline">
                            <div class="form-group">
                                <label for="ma">Mã câu hỏi:</label>
                                <asp:TextBox ID="txtMa" runat="server" class="form-control" TextMode="Number"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="ma">Thứ tự:</label>
                                <asp:TextBox ID="txtCount" runat="server" class="form-control" TextMode="Number"></asp:TextBox>
                            </div>
                            <asp:Button class="btn btn-primary" ID="btnThem" runat="server" Text="Thêm" OnClick="btnThem_Click" />
                            <asp:Button class="btn btn-primary" ID="btnTaoDe" runat="server" Text="Tạo đề" OnClick="btnTaoDe_Click" />
                        </div>
                    </div>
        ...
        <div id="divIn" style="display: none;" runat="server">
