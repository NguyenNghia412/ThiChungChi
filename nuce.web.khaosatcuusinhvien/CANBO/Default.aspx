<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="nuce.web.canbo.Default" %>
                ...
                <div class="body">
                    <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color: #0f297e;">
                            <a style="color: yellow; text-align: center; cursor: pointer; font-weight: bold; font-size: large" href="/canbo/SinhVienTruocKhiTotNghiep.aspx">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color: #ead7af;">
                            <a style="color: #0f297e; cursor: pointer; font-weight: bold; font-size: large" href="/canbo/CuuSinhVien.aspx">
                                <p style="text-align: center; text-transform: uppercase;">
