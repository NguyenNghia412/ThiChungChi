<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotRead.aspx.cs" Inherits="nuce.web.phanhoi.st.NotRead" %>
            ...
            <div class="row ">
                    ...
                    <div class="menuheader1" runat="server" id="mo_menuheader">
                        ...
                        <select>
                            <option value="/phanhoi/st/Default.aspx">Trang chủ</option>
                             <option value="/phanhoi/st/NotRead.aspx">Phản hồi chưa đọc</option>
                ...
                <div class="body">
                    <div class="col-md-12 col-xs-12">
                        <div class="form_dk">
                            <div id="infoSt" style="color: dodgerblue; font-weight: bold;" runat="server">
                            </div>
