<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditFeedBack.aspx.cs" Inherits="nuce.web.phanhoi.st.EditFeedBack" %>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div style="border: 1px solid #ccc; padding: 10px 10px; margin-bottom: 10px; min-height: 245px;">
                            <div class="form-group">
                                ...
                                <asp:DropDownList class="form-control" runat="server" ID="ddlGiangVien" AutoPostBack="false">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                            ...
                            <asp:Button runat="server" Text="Cập nhật" class="btn btn-default" ID="btnUpdate" OnClick="btnUpdate_Click" />
