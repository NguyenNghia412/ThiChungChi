<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditInfo.aspx.cs" Inherits="nuce.web.phanhoi.st.EditInfo" %>
            ...
            <div class="row ">
                <div id="header">
                    ...
                    <div class="menuheader1" runat="server" id="mo_menuheader">
                        ...
                        <select>
                            <option value="/phanhoi/st/Default.aspx">Đặt câu hỏi</option>
                        </select>
                        <div class="clearfix">
                        </div>
                    </div>
                ...
                <div class="body">
                    <div class="col-md-12 col-xs-12">
                        <div style="border: 1px solid #ccc; padding: 10px 10px; margin-bottom: 10px; min-height: 285px;">
                            <div class="form-group">
                                <label>Mã số sinh viên:</label>
                                <span runat="server" id="spMaSV" style="color: red;"></span>
                                <label>Họ và tên:</label>
                                <span runat="server" id="spName" style="color: red;"></span>
                            </div>
                            <div class="form-group">
                                <label>Email:</label>
                                <asp:TextBox class="form-control" runat="server" ID="txtEmail" TextMode="Email"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Mobile:</label>
                                <asp:TextBox class="form-control" runat="server" ID="txtMobile" TextMode="Number"></asp:TextBox>
                            </div>
                            <asp:Button runat="server" Text="Cập nhật" class="btn btn-default" ID="btnCapNhat" OnClick="btnCapNhat_Click" />
