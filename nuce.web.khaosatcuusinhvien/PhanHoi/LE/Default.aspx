<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="nuce.web.phanhoi.le.Default" %>
            ...
            <div class="row ">
                <div id="header">
                    ...
                    <div class="menuheader1" runat="server" id="mo_menuheader">
                        ...
                        <select>
                            <option value="/phanhoi/le/Default.aspx">Trang chủ</option>
                            <option value="/phanhoi/le/NotRead.aspx">Phản hồi chưa đọc</option>
                            <option value="/phanhoi/le/Message.aspx">Thông báo</option>
                        </select>
                        <div class="clearfix">
                        </div>
                    </div>
                ...
                <div class="body">
                    <div class="col-md-12 col-xs-12">
                        <div class="form_dk">
                            <div id="infoLe" style="color: dodgerblue; font-weight: bold;" runat="server"></div>
