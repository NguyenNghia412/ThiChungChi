<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="nuce.web.qa.Default" %>
            ...
            <div class="row ">
                <div id="header">
                    ...
                    <div class="menuheader1" runat="server" id="mo_menuheader">
                        ...
                        <select>
                            <option value="/phanhoi/Default.aspx">Lựa chọn</option>
                            <option value="/phanhoi/Default.aspx">Home</option>
                        </select>
                        <div class="clearfix">
                        </div>
                    </div>
                ...
                <div class="body">
                    <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color: #0f297e;">
                             <a style="color: yellow;text-align: center; cursor: pointer; font-weight: bold; font-size: large" href="/phanhoi/le/login.aspx">
                                 </br>
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="form_home" style="background-color:floralwhite;">
                            <a style="color: #0f297e;cursor: pointer; font-weight: bold; font-size: large" href="/phanhoi/st/login.aspx">
                                 </br>
                                <p style="text-align:center;text-transform: uppercase;">
                                  Sinh viên
                                </p>
