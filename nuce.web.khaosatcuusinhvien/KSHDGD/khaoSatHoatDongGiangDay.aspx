<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="khaoSatHoatDongGiangDay.aspx.cs" Inherits="nuce.web.khaosatcuusinhvien.khaoSatHoatDongGiangDay" %>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="body">
                        ...
                        <div style="width:95%; border: 1px solid #ccc; padding: 90px 10px; margin: auto; min-height: 200px; font-size:26px; color:red;">
                            <p style="text-align: center; font-weight: bold;">CHƯA ĐẾN THỜI GIAN KHẢO SÁT</p>
                        </div>
