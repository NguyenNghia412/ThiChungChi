...
namespace nuce.web.Handler.nuce.ad.thichungchi
{
    ...
    public class ad_tcc_update_phong_ca : CoreHandlerCommonAdminThiChungChi
    {
        public override void WriteData(HttpContext context)
        {
            ...
            try
            {
                ...
                string sql = $@"update [dbo].[Nuce_ThiChungChi_PhongThi_Cathi]
                            set PhongThiID = {idPhong}, CaThiID = {idCa}, NgayThi = '{ngayThi}', UpdatedTime = getdate()
                            where id = {id}";
