<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductInsertSettings.ascx.cs"
    Inherits="TH.NUCE.Web.ProductInsertSettings" %>
...
<table cellspacing="1" cellpadding="1" width="100%" border="0">
    ...
    <tr>
        ...
        <td width="70%">
            <asp:TextBox ID="txtExtension" runat="server"  Width="100%"></asp:TextBox>
        </td>
    </tr>
</table>
