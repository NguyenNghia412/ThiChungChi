<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="XacNhanUuDaiTrongGiaoDuc_YeuCauMoi.aspx.cs" Inherits="Nuce.CTSV.XacNhanUuDaiTrongGiaoDuc_YeuCauMoi" %>
        ...
        <div class="row row-no-gutters">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/dichvu/XacNhanUuDaiTrongGiaoDuc">Xác nhận ưu đãi trong giáo dục</a></li>
                    <li>Yêu cầu mới</li>
                </ul>
            </div>
        </div>
            ...
            <div style="width: 50%;">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtLyDoXacNhan" runat="server" class="form-control" TextMode="MultiLine" placeholder="Lý do xác nhận"></asp:TextBox>
                    </div>
                    <%--                    <div class="form-group">
